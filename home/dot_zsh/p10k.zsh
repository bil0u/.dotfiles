# Generated by Powerlevel10k configuration wizard on 2022-07-23 at 02:59 CEST.
...
() {
  ...
  # When `dir` segment is on the last prompt line, try POWERLEVEL9K_RIGHT_SEGMENT_SEPARATORto shorten it enough to leave at least this
